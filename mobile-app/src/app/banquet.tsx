...
export default function BanquetScreen() {
  ...
  return <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
    <Text style={styles.eyebrow}>CELEBRATE WITH DAMRU</Text><Text style={styles.title}>Make it memorable.</Text><Text style={styles.copy}>Tell us what you’re planning and our wedding and events team will help shape every delicious detail.</Text>
